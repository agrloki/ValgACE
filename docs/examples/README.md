...
1. Скопируйте все три файла в одну папку:
   ```bash
   cp ace-dashboard.html ace-dashboard.css ace-dashboard.js /path/to/web/directory/
   ```
...
### Вариант 4: Nginx (рекомендуется для продакшена)
